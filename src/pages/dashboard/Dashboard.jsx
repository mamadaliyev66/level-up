...
<div>
            ...
            {isLoading?(
             ...
             <div>
                 ...
                 <aside id="logo-sidebar" className={sidebar?(" fixed top-30 left-0 z-10  w-64 h-screen pt-2 transition-transform  bg-gray-800 text-white  translate-x-0 "):("fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-gray-800 text-white ")} aria-label="Sidebar">
                 <button onClick={OpenCloseSideBar} type="button" className="inline-flex border-2 text-red-500 border-white  ml-44 items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden  focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 ">
                            X
                         </button>
